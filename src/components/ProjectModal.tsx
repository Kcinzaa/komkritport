...
import {
  X, ExternalLink, GitFork, Code2,
  CheckCircle2, Clock, User,
  Globe, BarChart3, UtensilsCrossed, Trees,
} from "lucide-react";
...
// ทวงเบี้ยแม่ ใช้ Apps Script แทน GitHub
const codeLabel: Record<string, string> = {
  "tawng-bia-mae": "View Apps Script",
};
            ...
            <div className="flex min-h-full items-center justify-center p-4 md:p-8">
              ...
              >
                ...
                <div className="relative w-full overflow-hidden" style={{ paddingBottom: "52%" }}>
                  ...
                  <button
                    onClick={onClose}
                    className="absolute top-4 right-4 w-9 h-9 rounded-full bg-black/50 hover:bg-black/80 border border-white/[0.12] flex items-center justify-center transition-colors duration-200 text-neutral-400 hover:text-white backdrop-blur-md"
                  >
                    <X size={15} />
                  </button>

                  {/* Title bottom-left (on top of gradient) */}
                  <div className="absolute bottom-5 left-6 right-16">
                    <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight leading-tight drop-shadow-lg">
                      {project.title}
                    </h2>
                    <p className="text-sm font-semibold mt-1 drop-shadow" style={{ color: project.color }}>
                      {project.subtitle}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 md:p-8">
                  <div className="grid md:grid-cols-5 gap-8">
                    ...
                    <div className="md:col-span-3 space-y-7">
                      <div>
                        <p className="text-[10px] text-neutral-600 uppercase tracking-widest font-bold mb-3">About</p>
                        <p className="text-sm text-neutral-400 leading-[1.85]">{project.longDesc}</p>
                      </div>

                      <div>
                        <p className="text-[10px] text-neutral-600 uppercase tracking-widest font-bold mb-3">Key Features</p>
                    ...
                    <div className="md:col-span-2 space-y-5">
                      ...
                      <div className="grid grid-cols-2 gap-2.5">
                        {[
                          { icon: <User size={12} />,  label: "Role",     value: project.role },
                          { icon: <Clock size={12} />, label: "Duration", value: project.duration },
                        ].map((m) => (
                      ...
                      <div className="flex flex-col gap-2 pt-1">
                        {project.live !== "#" && (
                          <a
                            ...
                            className="flex items-center justify-center gap-2 py-3 rounded-xl font-bold text-sm transition-all duration-200 hover:scale-[1.02] hover:shadow-lg"
                            style={{
                        ...
                        {project.github !== "#" && (
                          ...
                          >
                            ...
                            {codeLabel[project.id] ?? "View Code"}
                          </a>
                        )}
                      </div>
                    </div>
